...
class vioFixedLagSmoother {

public:

  /// Typedef for a shared pointer to an Incremental Fixed-Lag Smoother
  typedef boost::shared_ptr<vioFixedLagSmoother> shared_ptr;
  ...
  /** default constructor */
  vioFixedLagSmoother(double smootherLag = 0.0) : smootherLag_(smootherLag) { }

  /** destructor */
  virtual ~vioFixedLagSmoother() { }

  /** Print the factor for debugging and testing (implementing Testable) */
  virtual void print(const std::string& s = "vioFixedLagSmoother:\n", const KeyFormatter& keyFormatter = DefaultKeyFormatter) const;
...
typedef vioFixedLagSmoother::KeyTimestampMap vioFixedLagSmootherKeyTimestampMap;
typedef vioFixedLagSmootherKeyTimestampMap::value_type vioFixedLagSmootherKeyTimestampMapValue;
typedef vioFixedLagSmoother::Result vioFixedLagSmootherResult;
