...
const Eigen::Vector3d CameraPoseVisualization::imlt = Eigen::Vector3d(-3, -3,  1.5);
const Eigen::Vector3d CameraPoseVisualization::imrt = Eigen::Vector3d(-3,  3,  1.5);
const Eigen::Vector3d CameraPoseVisualization::imlb = Eigen::Vector3d(-3, -3, -1.5);
const Eigen::Vector3d CameraPoseVisualization::imrb = Eigen::Vector3d(-3,  3, -1.5);
const Eigen::Vector3d CameraPoseVisualization::lt0 = Eigen::Vector3d(-3, -2.1, 1.5);
const Eigen::Vector3d CameraPoseVisualization::lt1 = Eigen::Vector3d(-3, -2.1, 0.6);
const Eigen::Vector3d CameraPoseVisualization::lt2 = Eigen::Vector3d(-3, -3, 0.6);
